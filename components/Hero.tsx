      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className=" p-8 sm:p-12">
          ...
          >
            ...
            <span className="text-skyBlue">DEGEN</span> Investing
          </motion.h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
           ...
           Launch App
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white/10 text-skyBlue px-8 py-3 rounded-full font-medium backdrop-blur-sm border border-skyBlue hover:bg-white/20 transition-colors"
            >
              Learn More
            </motion.button>
          </div>
